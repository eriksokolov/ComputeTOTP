...
if([BitConverter]::IsLittleEndian){[array]::Reverse($c)};$h=[Security.Cryptography.HMACSHA1]::new($k).ComputeHash($c);
$o=$h[-1]-band 15;((($h[$o]-band 127)-shl 24)-bor(($h[$o+1]-band 255)-shl 16)-bor(($h[$o+2]-band 255)-shl 8)-bor($h[$o+3]-band 255))%1000000 -as [int] |
% ToString D6
